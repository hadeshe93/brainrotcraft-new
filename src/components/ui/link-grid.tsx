    ...
    >
      {items.map((item) => (
        <Link
          ...
          className="bg-card hover:bg-accent/10 group border-border flex h-24 items-center justify-center rounded-lg border p-4 text-center shadow-sm transition-all duration-200 hover:shadow-md"
        >
