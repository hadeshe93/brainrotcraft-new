/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 98c780f6f22ad8304211b84c6eda281a)
// Runtime types generated with workerd@1.20250803.0 2025-08-22 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
  interface Env {
    KV: KVNamespace;
    NEXTJS_ENV: string;
    OPENROUTER_API_KEY: string;
    CLOUDFLARE_R2_WRITE_TOKEN: string;
    NEXT_AUTH_SECRET: string;
    AUTH_GOOGLE_SECRET: string;
    REPLICATE_API_TOKEN: string;
    REPLICATE_PREDICTION_WEBHOOK_SECRET: string;
    CF_TURNSTILE_SECRET_KEY: string;
    R2: R2Bucket;
    DB: D1Database;
    QUEUE: Queue<any>;
    BaseDO: DurableObjectNamespace<import('./worker/src/index').BaseDO>;
    ThrottlerDO: DurableObjectNamespace<import('./worker/src/index').ThrottlerDO>;
    BASE_DO_SERVICE: Service<import('./worker/src/index').BaseDORpcService>;
    THROTTLE_SERVICE: Service<import('./worker/src/index').ThrottleRpcService>;
    ASSETS: Fetcher;
  ...
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        | 'NEXTJS_ENV'
        | 'CLOUDFLARE_R2_WRITE_TOKEN'
        | 'NEXT_AUTH_SECRET'
        | 'AUTH_GOOGLE_SECRET'
        | 'REPLICATE_API_TOKEN'
        | 'REPLICATE_PREDICTION_WEBHOOK_SECRET'
        | 'REPLICATE_LOCAL_WEBHOOK_ORIGIN'
