/**
 * Category Import Tool
 * Reads categories from JSON file and imports via API
 */
...
const API_PATH = '/api/admin/categories/import';
const DEFAULT_FILE = 'tools/rewrite/cate-and-tag/output/game-categories.json';
